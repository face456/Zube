...
class AuthService {
    ...
    var authToken: String {
        get {
            return defaults.value(forKey: TOKEN_KEY) as? String ?? "" // this makes sure it can't be nil
        }
        set {
    ...
    var userEmail: String {
        get {
            return defaults.value(forKey: USER_EMAIL) as? String ?? "" // this makes sure it can't be nil
        }
        set {
